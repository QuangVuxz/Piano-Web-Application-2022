...
main .music_card button:hover:before{
    width:30%;
}
main .music_card button:hover:after{
    width:30%;
}
    </style>
    <title>Piano</title>
  ...
  <body>
    ...
    if(isset($_POST['input'])){
        $input = $_POST['input'];
        $query = "SELECT * from lession_db WHERE lession_name LIKE '%{$input}%'";
